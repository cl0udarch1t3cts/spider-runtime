...
def create_app(control: Control) -> FastAPI:
    ...
    @app.post("/api/v1/execution-jobs/scrape-failed", response_model=ScrapeAllView, status_code=202)
    def scrape_failed() -> dict:
        return control.enqueue_failing(trigger="console")
